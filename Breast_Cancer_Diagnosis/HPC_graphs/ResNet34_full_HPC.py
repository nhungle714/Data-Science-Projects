...
#                 if epoch % 5 == 4:
    ...
    torch.save(model, os.path.join(graph_path, 'BestResNet34_tl_FullData.pt'))
...
PlotAccLoss(BestResNet34_tl, 'ResNet34_FullData')
...
BestResNet34_tl = torch.load(os.path.join(graph_path, 'BestResNet34_tl_FullData.pt')) 
